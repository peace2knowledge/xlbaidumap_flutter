...
import com.example.xlbaidumapflutter.R;
...
public class MapAdapter extends XRvPureDataAdapter<PoiInfo> {
    ...
    public void onBindViewHolder(XRvViewHolder holder, int position) {
        ...
        if(mIndexTag==position){
            bigTv.setTextColor(ContextCompat.getColor(MyApplication.mContext,R.color.app_sub_color));
            minTv.setTextColor(ContextCompat.getColor(MyApplication.mContext,R.color.app_sub_color));
        }else{
            bigTv.setTextColor(ContextCompat.getColor(MyApplication.mContext,R.color.app_txt_black));
            minTv.setTextColor(ContextCompat.getColor(MyApplication.mContext,R.color.app_txt_gray_light));
        }
    }
